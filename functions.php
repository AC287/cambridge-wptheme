...
function cambridge_script_enqueue() {
  ...
  wp_enqueue_style('customstyle',get_template_directory_uri().'/css/cambridge.css', array(), '1.0.74', 'all');
  ...
  wp_enqueue_script('customjs',get_template_directory_uri().'/js/cambridge.js', array('jquery'), '1.0.33', true);
