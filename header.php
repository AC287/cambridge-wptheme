        ...
        <div class="container">
          ...
          <div class="navi1-btn">
            <ul>
              ...
              <li class="navcust-dropdown">
                <a class="navcust-dropbtn">
                  <div class="header-nav-title">PRODUCTS</div>
                  <div class="header-navi-selector"></div>
                </a>
                <div class="navcust-dropdown-content">
                  <div>
                  ...
                  <div>
                    <a class="products" href="<?php echo home_url();?>/products/catalogs">
                      <div class="header-navi-title">CATALOGS</div>
                      <div class="header-navi-selector"></div>
                    </a>
                  </div>
                </div>
