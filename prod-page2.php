	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			echo "<div class='group-container'>";
				if($p2s2!=""){
					echo "<div class='m-title'><a href='../pm0/?m0=".urlencode($p2m0)."'>".$p2m0."</a>  >>  <a href='../ps1/?m0=".urlencode($p2m0)."&s1=".urlencode($p2s1)."'>".$p2s1."</a>  >>  ".$p2s2."</div>";	//Title
					...
					echo "<div class='m-title'><a href='../pm0/?m0=".urlencode($p2m0)."'>".$p2m0."</a>  >>  ".$p2s1."</div>";	//Title
